...
public class ActivityHomeBindingImpl extends ActivityHomeBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.lav_home_lock, 12);
        sViewsWithIds.put(R.id.iv_home_empty, 13);
        sViewsWithIds.put(R.id.tv_home_empty, 14);
    }
    // views
    @NonNull
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0xfL) != 0) {
            ...
            if ((dirtyFlags & 0xdL) != 0) {
                    ...
                    updateLiveDataRegistration(0, HomeViewModelIsEmpty1);
            ...
            if ((dirtyFlags & 0xeL) != 0) {
                    ...
                    updateLiveDataRegistration(1, homeViewModelCardList);
    ...
    /* flag mapping
        flag 0 (0x1L): homeViewModel.isEmpty
        flag 1 (0x2L): homeViewModel.cardList
